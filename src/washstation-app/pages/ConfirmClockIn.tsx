...
/**
 * Confirm Clock In Page
 * 
 * Confirmation gate before entering dashboard
 * - Displays staff info, branch, time
 * - Must click Confirm to proceed
 * - Matches "Confirm Clock Out" UI style exactly
 */
